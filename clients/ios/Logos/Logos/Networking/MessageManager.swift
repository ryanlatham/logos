...
protocol MessageManagerHost: AnyObject {
    ...
    @discardableResult func sendMessageFrame(_ frame: [String: Any], onCompletion: (@MainActor @Sendable (Result<Void, Error>) -> Void)?) async -> Bool
